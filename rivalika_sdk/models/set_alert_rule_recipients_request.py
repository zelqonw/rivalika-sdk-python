...
class SetAlertRuleRecipientsRequest(BaseModel):
    """
    SetAlertRuleRecipientsRequest
    """ # noqa: E501
    recipients: List[SetAlertRuleRecipientsRequestRecipientsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recipients": [SetAlertRuleRecipientsRequestRecipientsInner.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None
        })
        return _obj
